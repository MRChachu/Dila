          ...
          {!inRoom && (
              <div className="w-full pb-6 pt-2 flex flex-col items-center justify-center gap-1.5 animate-in fade-in duration-1000">
                  ...
                  <div className="flex items-center gap-1.5 bg-stone-950/60 p-1.5 md:p-2 rounded-2xl border border-white/5 shadow-inner">
                      {/* Facebook */}
                      <a href="https://facebook.com/შენი_გვერდი" target="_blank" rel="noreferrer" className="p-2 md:p-2.5 bg-stone-900 border border-white/10 hover:border-blue-500/50 rounded-xl text-stone-400 hover:text-blue-400 hover:bg-blue-500/10 transition-all shadow-md active:scale-95 group">
                      ...
                      {/* Instagram */}
                      <a href="https://instagram.com/შენი_გვერდი" target="_blank" rel="noreferrer" className="p-2 md:p-2.5 bg-stone-900 border border-white/10 hover:border-pink-500/50 rounded-xl text-stone-400 hover:text-pink-400 hover:bg-pink-500/10 transition-all shadow-md active:scale-95 group">
                      ...
                      {/* TikTok */}
                      <a href="https://tiktok.com/@შენი_გვერდი" target="_blank" rel="noreferrer" className="p-2 md:p-2.5 bg-stone-900 border border-white/10 hover:border-stone-300/50 rounded-xl text-stone-400 hover:text-stone-200 hover:bg-stone-300/10 transition-all shadow-md active:scale-95 group">
